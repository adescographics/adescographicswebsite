...
const words = ["build", "design", "create", "launch", "fix", "repair", "help", "serve", "update", "upgrade", "project", "write", "publish", "prototype", "inspire", "enlighten", "solve", "craft", "develop", "innovate", "deliver", "engineer"];
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          <source src="/est_video.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 py-16 sm:py-24 md:py-32 lg:py-40">
        ...
        <div className="mb-8 sm:mb-12">
          <h1 
            className={`text-left text-[clamp(1.5rem,5vw,7rem)] font-display leading-[0.92] tracking-tight text-white transition-all duration-1000 ${
      ...
      >
        <div className="max-w-[1400px] mx-auto grid grid-cols-3 sm:flex sm:items-start gap-4 sm:gap-10 lg:gap-20">
          {[
            ...
            <div key={stat.label} className="flex flex-col gap-1 sm:gap-2">
              <span className="text-xl sm:text-3xl lg:text-4xl font-display text-white">{stat.value}</span>
