      ...
      >
        ...
        >
          ...
          <a href="/" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>ADESCO</span>
            <span className={`font-mono transition-all duration-500 ${isScrolled ? "text-[10px] mt-0.5 text-muted-foreground" : "text-xs mt-1 text-white/60"}`}>Graphics</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button
              ...
              className={`rounded-full transition-all duration-500 ${isScrolled ? "bg-foreground hover:bg-foreground/90 text-background px-6 h-8 text-xs" : "bg-white hover:bg-white/90 text-black px-8"}`}
            >
              Contact
            </Button>
          </div>
      ...
      >
        <div className="flex flex-col h-full px-8 pt-20 pb-8">
          ...
          <div className="flex items-center justify-between mb-12">
            <a href="/" className="flex items-center gap-2 group">
              <span className="font-display tracking-tight text-xl text-foreground">ADESCO</span>
