      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-md">
            Working with Adesco Graphics means partnering with a team dedicated to your success.
            We combine technical excellence with genuine care for your business goals.
          </p>
