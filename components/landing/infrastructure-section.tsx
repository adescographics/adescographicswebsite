...
const regions = [
  { name: "Web Development", nodes: 12, status: "specialized" },
  { name: "IT Solutions", nodes: 8, status: "specialized" },
  { name: "Content Creation", nodes: 6, status: "specialized" },
  { name: "System Support", nodes: 3, status: "specialized" },
];
...
export function InfrastructureSection() {
  ...
  return (
    <section id="infra" ref={sectionRef} className="relative py-12 md:py-24 lg:py-32 lg:py-40 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-4 sm:gap-6 md:gap-8 lg:gap-16 items-stretch">
            {/* Image globe — colonne gauche, pleine hauteur */}
            <div className={`w-32 sm:w-48 lg:w-72 xl:w-80 shrink-0 transition-all duration-1000 ${
            ...
            <div className="flex flex-col justify-center">
              <h2 className={`text-4xl sm:text-5xl md:text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}>
                Cutting-edge
                <br />
              ...
              <p className={`mt-4 sm:mt-8 text-sm sm:text-base lg:text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                isVisible ? "opacity-100" : "opacity-0"
              }`}>
                We use the latest technologies to build robust, scalable solutions for your business needs.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                ...
                <span className="text-2xl text-muted-foreground">service areas</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                Specialized expertise across web, IT, content, and creative services.
              </p>
            </div>
          </div>
        ...
        <div className={`mt-12 grid grid-cols-2 lg:grid-cols-4 gap-4 transition-all duration-1000 delay-300 ${
          ...
          {regions.map((region, index) => (
            ...
            >
              ...
              <span className="text-sm text-muted-foreground">{region.nodes} specialists</span>
            </div>
          ))}
        </div>
      </div>
