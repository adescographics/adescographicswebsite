...
export function PricingSection() {
  ...
  return (
    <section id="pricing" ref={sectionRef} className="relative py-12 md:py-24 lg:py-32 lg:py-40">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
        {/* Header - Dramatic offset */}
        <div className="grid lg:grid-cols-12 gap-4 sm:gap-8 mb-12 sm:mb-16 md:mb-20">
          <div className="lg:col-span-7">
            <span className="inline-flex items-center gap-2 sm:gap-3 text-xs sm:text-sm font-mono text-muted-foreground mb-4 sm:mb-8">
              ...
              >
                ...
                <div className="p-4 sm:p-6 md:p-8 lg:p-10">
                  ...
                  <div className="mb-6 sm:mb-8 pb-4 sm:pb-8 border-b border-foreground/10">
                    ...
                    <h3 className="text-xl sm:text-2xl md:text-2xl lg:text-3xl font-display mt-2">{plan.name}</h3>
                  ...
                  <div className="mb-6 sm:mb-8">
                    {plan.price.monthly !== null ? (
                      ...
                      <span className="text-2xl sm:text-3xl md:text-4xl font-display">Custom</span>
                    )}
        ...
        <div className={`mt-12 sm:mt-16 md:mt-20 flex flex-col md:flex-row md:items-center md:justify-between gap-4 sm:gap-8 pt-6 sm:pt-8 md:pt-12 border-t border-foreground/10 transition-all duration-1000 delay-500 ${
